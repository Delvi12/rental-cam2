...
<div class="about">
	<div class="container">
		<div class="about-top wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">
			...
			<p>Rental Kamera ini merupakan salah satu penyedia layanan rental kamera di Malang. Menggunakan merek - merek keluaran baru, dengan kondisi terawat untuk disewakan kepada Anda. Dengan pilihan kamera yang kami sediakan sangat variatif dan harga yang sangat kompetitif di .  Kami menawarkan untuk Anda seperti: Kamera Saku (Compact Camera), Bridge Camera (Prosumer), Kamera Mirrorless, Kamera Aksi (Action Camera), Kamera Digital Single Lens Reflex (DSLR). Anda dapat menyewa untuk harian maupun bulanan.</p>
		</div>
		<div class="about-mid">
			<div class="col-md-6 abt-lft wow fadeInLeft animated" data-wow-delay=".5s">
				<h3>Mission</h3>
				<p>Kami selalu berusaha untuk menyediakan kamera yang terbaru dan optimal untuk mengabadikan moment anda dan kami akan membangun kinerja yang memuaskan untuk klien kami..</p>
				</div>
			<div class="clearfix"></div>
		</div>
		<div class="about-top wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">
			<h2>Servis Gratis</h2>
			<p>Customer akan kami berikan fasilitas bebas perawatan kendaraan selama dalam masa rental terkecuali jika kendaraan rusak akibat kelalaian atau kesalahan penggunaan..</p>
		</div>
			<div class="clearfix"></div>
		</div>
	</div>
